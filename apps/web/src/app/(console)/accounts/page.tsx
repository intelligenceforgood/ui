  ...
  return (
    <div className="space-y-10">
      <header className="space-y-3">
        ...
        <h1 className="text-3xl font-semibold text-slate-900">Account list extraction</h1>
        <p className="max-w-3xl text-sm text-slate-500">
          Launch manual runs across bank, crypto, and payment indicators. The console surfaces run summaries,
          warnings, and artifact links once extraction completes.
        </p>
      </header>
