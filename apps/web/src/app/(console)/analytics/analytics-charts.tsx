    ...
    <section className="grid gap-4 xl:grid-cols-2">
      <Card className="flex h-80 flex-col">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-slate-900">Detection rate</h2>
        ...
        <div className="mt-4 flex-1">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={data.pipelineBreakdown}>
              ...
              <Tooltip />
              <Bar dataKey="value" fill={palette.secondary} radius={[6, 6, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </Card>
      ...
      <Card className="flex h-80 flex-col">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-slate-900">Weekly incidents vs interventions</h2>
      ...
      <Card className="flex h-80 flex-col">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-slate-900">Geography coverage</h2>
        ...
        <div className="mt-4 flex-1">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={data.geographyBreakdown} layout="vertical">
              ...
              />
              <Tooltip />
              <Bar dataKey="value" fill={palette.neutral} radius={[0, 6, 6, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </Card>
