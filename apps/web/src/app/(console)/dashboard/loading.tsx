    ...
    <div className="animate-pulse space-y-8">
      <section className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="space-y-3">
          ...
          <div className="h-9 w-80 rounded-sm bg-slate-200" />
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {[...Array(4)].map((_, i) => (
          ...
          >
            ...
            <div className="mt-4 h-8 w-16 rounded-sm bg-slate-200" />
          </div>
        ))}
      </section>
      ...
      <section className="grid gap-6 xl:grid-cols-[2fr_1fr]">
        ...
        <div className="space-y-6">
          <div className="h-52 rounded-2xl border border-slate-100 bg-white/80 p-6">
            <div className="h-5 w-28 rounded-sm bg-slate-200" />
            <div className="mt-4 space-y-3">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="h-10 rounded-sm bg-slate-100" />
              ))}
            </div>
          </div>
          <div className="h-36 rounded-2xl border border-slate-100 bg-white/80 p-6">
            <div className="h-5 w-24 rounded-sm bg-slate-200" />
            <div className="mt-4 space-y-2">
              {[...Array(2)].map((_, i) => (
                <div key={i} className="h-4 w-full rounded-sm bg-slate-100" />
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {[...Array(4)].map((_, i) => (
            ...
            >
              ...
              <div className="mt-6 h-4 w-32 rounded-sm bg-slate-200" />
              <div className="mt-2 h-4 w-48 rounded-sm bg-slate-100" />
            </div>
          ))}
        </div>
      </section>
