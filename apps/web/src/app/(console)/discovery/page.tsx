...
export const metadata: Metadata = {
  ...
  description: "Run Google Discovery Engine searches alongside the analyst console workflows.",
};
  ...
  return (
    <div className="space-y-8">
      <header className="space-y-4">
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-slate-400">Discovery Engine</p>
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-3">
            <h1 className="text-3xl font-semibold text-slate-900 dark:text-white">Search the 627-case Discovery Engine index</h1>
