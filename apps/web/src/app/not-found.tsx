...
export default function NotFound() {
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="w-full max-w-md space-y-6 rounded-2xl border border-slate-200 bg-white/80 p-8 text-center shadow-xs backdrop-blur-sm dark:border-slate-700 dark:bg-slate-900/80">
