...
interface SsiDedupWarningModalProps {
  isOpen: boolean;
  onClose: () => void;
  url: string;
...
/**
 * Modal shown on the standalone /ssi page when a submitted URL
 * was recently investigated. Offers to view the existing result
 * or re-investigate with force=true.
 */
export function SsiDedupWarningModal({
  isOpen,
  onClose,
  url,
  existingScanId,
    ...
    <DialogPrimitive.Root open={isOpen} onOpenChange={() => onClose()}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          ...
          aria-describedby="ssi-dedup-description"
        >
          ...
          <div id="ssi-dedup-description" className="mt-3 space-y-3">
          ...
          <DialogPrimitive.Close
            className="absolute right-4 top-4 rounded-full p-1 text-slate-400 hover:text-slate-600 focus:outline-hidden"
            aria-label="Close"
          >
            <svg
              width="16"
